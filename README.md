...
| ------------------------------------------------------------------- | -------------------------------------------------------------------- | --------------------------- | --------------------------------------------------------- |
| **[Mini Trello](https://github.com/SergeySKA10/mini-trello)**       | Task management application with drag & drop functionality           | Next.js, TypeScript, Redux, Express.js    | [🔗 In progress](https://github.com/SergeySKA10/mini-trello)                |
...
| ---------------------------------------------------------------------- | ------------------------------------------------------------------------ | --------------------------- | --------------------------------------------------------- |
| **[Mini Trello](https://github.com/SergeySKA10/mini-trello)**          | Приложение для управления задачами с drag & drop                         | Next.js, TypeScript, Redux, Express.js  | [🔗 В доработке](https://github.com/SergeySKA10/mini-trello)           |
