...
| ------------------------------------------------------------------- | -------------------------------------------------------------------- | --------------------------- | --------------------------------------------------------- |
| **[Mini Trello](https://github.com/SergeySKA10/mini-trello)**       | Task management application with drag & drop functionality           | Next.js, TypeScript, Redux, Express.js    | [🔗 Live Demo]()                |
...
| ---------------------------------------------------------------------- | ------------------------------------------------------------------------ | --------------------------- | --------------------------------------------------------- |
| **[Mini Trello](https://github.com/SergeySKA10/mini-trello)**          | Приложение для управления задачами с drag & drop                         | Next.js, TypeScript, Redux, Express.js  | [🔗 Демо]()           |
